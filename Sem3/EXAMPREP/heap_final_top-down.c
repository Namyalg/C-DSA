...
int main()
{
  ...
  //this is the top down method where u are heapifying as and when each element is added


  //if nothing is mentioned then go for the bottom up approach

  //add all elements to the heap and the heapify from count of nodes / 2 to 0

  //this is inplace bottom up heapification
